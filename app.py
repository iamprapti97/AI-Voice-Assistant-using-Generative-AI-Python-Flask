...
os.environ["GOOGLE_API_KEY"] = "AIzaSyCDkzlNlkzPs8Tej_OzdzgANB8LVUoDBVQ"
...
def voice_assistance(user_input):
    ...
    prompt = f"""
    You are an AI assistant (your name is "VOXIS") in an engaging conversation with a user. The user just asked the following question:
    '{user_input}'
